            ...
            <div class="card-body">
                <form action="{{ $action }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" disabled name="rfid" id="rfid" class="form-control" value="{{ $rfid->uid ?? old('uid') }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nama_siswa" id="nama_siswa" class="form-control" value="{{ $rfid->nama_siswa ?? old('nama_siswa') }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nipd" id="nipd" class="form-control" value="{{ $rfid->nipd ?? old('nipd') }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nisn" id="nisn" class="form-control" value="{{ $rfid->nisn ?? old('nisn') }}">
