...
<body class="light ">
    <div class="wrapper vh-100" style="background-image: url({{ asset('/assets/images/background.jpeg') }}) !important; background-size:cover; object-position: center; opacity: .8;">
        <div class="row align-items-center h-100 w-100">
            <form class="col-lg-4 col-md-4 col-10 mx-auto text-center bg-light rounded" action="{{ route('login') }}" method="POST" style="padding: 22px !important;">
                @csrf
