<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item {{ request()->is('users*') || request()->is('jurusan*') || request()->is('angkatan*') || request()->is('jadwal*') ? 'active' : '' }} dropdown">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item {{ request()->is('device*') || request()->is('rfid*') || request()->is('history*') ? 'active' : '' }} dropdown">
                <a href="#data-devices" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    <i class="fe fe-grid fe-16"></i>
                    <span class="ml-3 item-text">Data Devices</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="data-devices">
                    <li class="nav-item">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item {{ request()->is('absensi*') || request()->is('rfid*') ? 'active' : '' }} dropdown">
                <a href="#data-absensi" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    <i class="fe fe-list fe-16"></i>
                    <span class="ml-3 item-text">Data Absensi</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="data-absensi">
                    <li class="nav-item">
